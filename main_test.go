...
import (
	...
	"github.com/joshrwolf/wtee/pkg/commands/echo"
	"github.com/joshrwolf/wtee/pkg/commands/kgrep"
	"github.com/joshrwolf/wtee/pkg/commands/sfuzz"
	"github.com/joshrwolf/wtee/pkg/commands/wassert"
	"github.com/joshrwolf/wtee/pkg/commands/wexec"
	...
	cmd.AddCommand(
		&cobra.Command{
			...
			Run: func(cmd *cobra.Command, args []string) {
				...
				// This allows `wtee test --script foo` to work like `go test --args --script foo`
	...
	cmd.AddCommand(
		&cobra.Command{
			...
			Run: func(cmd *cobra.Command, args []string) {
				...
				sort.Strings(names)
				fmt.Fprintf(cmd.OutOrStdout(), strings.Join(names, " "))
			},
		},
	)
...
func TestScript(t *testing.T) {
	...
	// All tests will share the same parent context
